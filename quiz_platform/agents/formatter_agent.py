    ...
    def format_questions_for_database(
        ...
        for i, question in enumerate(questions):
            db_question = {
                ...
                # ✅ FIXED topic mapping
                "topic": question.get("normalized_topic") or question.get("topic") or "General",
                "subtopic": question.get("subtopic", ""),

                # ✅ FIXED page mapping
                "page_reference": question.get("page_number") or question.get("page_reference") or 1,

                # ✅ FIXED validation score mapping
                "validation_score": question.get("validation_score") or question.get("overall_score") or 0.0,
                ...
                "metadata": json.dumps({
                    ...
                    "original_data": {
                        ...
                        if key not in [
                            "question_text", "options", "answer", "correct_answer",
